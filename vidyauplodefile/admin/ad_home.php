            ...
            <div class="adjust-nav">
                <div class="navbar-header">
                    ...
                    <!-- <a class="navbar-brand" href="#">
                        <img src="vidya.png" height="100" width="70" class="img"/>
                    </a> -->
...
?>
    ...
    <div class="footer">
            <div class="row">
                <div class="col-lg-12" >
                    &copy;  2023 vidya.infinityfreeapp.com | Design by: <a href="http://binarytheme.com" style="color:#fff;" target="_blank">www.binarytheme.com</a>
                </div>
            </div>
        </div>
     <!-- /. WRAPPER  -->
